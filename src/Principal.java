...
public class Principal extends JFrame {
  ...
  private void jbInit() throws Exception  {
    ...
    this.setTitle("Monpoly simplifi� Java");
    ...
    jLabelLD.setText("Vous avez Tir� un :");
    jLabelWere.setText("Vous �tiez � la :");
    jButtonBuy.setPreferredSize(new Dimension(103, 20));
    jButtonBuy.setText("Acheter");


    jLabelLNC.setText("Vous �tes desormais � :");
    ...
    jLabelProp.setText("Propri�taire :");
